...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        String unitsPreferenceKey = context.getString(R.string.pref_units_key);
        String metricUnits = context.getString(R.string.pref_units_metric);

        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(unitsPreferenceKey, metricUnits).equals(metricUnits);
    }
    ...
    public static String getFormattedMonthDay(long dateInMillis) {
        Time time = new Time();
        time.setToNow();
        SimpleDateFormat monthDayFormat = new SimpleDateFormat("MMMM dd", Locale.UK);
